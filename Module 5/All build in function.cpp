...
Modifiers
    ...
    *   s.erase() -> erase characters from the string.  (4,1) 4 number charecter theke 1 ch bad dibe
    *   s.replace() -> replace a portion of the string. (4,1, "so") 4 numbar charecter er por 1 ta bad diye "so" bosabe
